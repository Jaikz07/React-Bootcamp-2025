...
const symptomsAndRemedies = {
    headache: {
      ...
      description: "A headache can be caused by a variety of factors, including stress, lack of sleep, and dehydration."
    },
    fever: {
      remedies: "Take medication like acetaminophen or ibuprofen to reduce the fever",
      description: "A fever can be caused by a viral or bacterial infection."
    },
    cough: {
      remedies: "Stay hydrated and use a humidifier to relieve congestion",
      description: "A cough can be caused by a variety of factors, including a cold, flu, or sinus infection."
    },
    soreThroat: {
      remedies: "Gargle with salt water and stay hydrated to soothe the throat",
      description: "A sore throat can be caused by a variety of factors, including a cold, flu, or sinus infection."
    },
    diarrhea: {
      remedies: "Stay hydrated and avoid solid foods for a while",
      description: "Diarrhea can be caused by a variety of factors, including a viral or bacterial infection."
    },
    nausea: {
      remedies: "Take medication like metoclopramide to relieve nausea",
      description: "Nausea can be caused by a variety of factors, including motion sickness, food poisoning, or a viral infection."
    },
    vomiting: {
      remedies: "Stay hydrated and avoid solid foods for a while",
      description: "Vomiting can be caused by a variety of factors, including a viral or bacterial infection."
    },
    fatigue: {
      remedies: "Get plenty of rest and stay hydrated",
      description: "Fatigue can be caused by a variety of factors, including a lack of sleep, dehydration, or a medical condition."
    },
    skinRash: {
      remedies: "Apply a topical cream or ointment to soothe the skin",
      description: "A skin rash can be caused by a variety of factors, including an allergic reaction, insect bite, or skin infection."
    },
    dizziness: {
      remedies: "Stay hydrated and avoid standing up too quickly",
      description: "Dizziness can be caused by a variety of factors, including dehydration, low blood pressure, or a medical condition."
    },
    anxiety: {
        remedies: "Practice deep breathing, engage in physical activity, and seek professional help if needed",
        description: "Anxiety can be caused by a variety of factors, including stress, medical conditions, or mental health disorders."
    },
    insomnia: {
        remedies: "Establish a regular sleep schedule, avoid caffeine, and create a relaxing bedtime routine",
        description: "Insomnia can be caused by a variety of factors, including stress, anxiety, and medical conditions."
    },
    backPain: {
        remedies: "Apply heat or ice, take pain relievers, and do gentle stretching exercises."
    },
    jointPain: {
